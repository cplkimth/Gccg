...
public class TrackDaoTest
{
    ...
    {
        var tracks = Dao.Track.GetAsync(x => x.AlbumId == 3).Result;
    ...
    {
        var tracks = Dao.Track.GetAsync(x => x.AlbumId == 4, x => x.Name, true).Result;
        Assert.AreEqual(6, tracks[0].TrackId);
        Assert.AreEqual(7, tracks[1].TrackId);
    }

    [TestMethod]
    public void Get7Async()
    {
        var tracks = Dao.Track.GetAsync(x => x.AlbumId == 3, x => x.Name, false).Result;
        Assert.AreEqual(5, tracks[0].TrackId);
        Assert.AreEqual(4, tracks[1].TrackId);
    }
    ...
    {
        var tracks = Dao.Track.GetAsync(x => x.AlbumId == 3, x => x.Name, true, 1, 1).Result;
        Assert.AreEqual(5, tracks[0].TrackId);
    ...
    {
        var tracks = Dao.Track.GetAsync(x => x.AlbumId == 3, x => x.Name, false, 1, 1).Result;
        Assert.AreEqual(4, tracks[0].TrackId);
        Assert.AreEqual(1, tracks.Count);
    }
    ...
    {
        var ids = Dao.Track.SelectAsync(x => x.AlbumId == 3, x => x.TrackId).Result;
    ...
    {
        var ids = Dao.Track.SelectAsync(x => x.AlbumId == 3, x => x.Name, true, x => x.TrackId).Result;
        Assert.AreEqual(4, ids[0]);
        Assert.AreEqual(5, ids[1]);
    }
    ...
    {
        var ids = Dao.Track.SelectAsync(x => x.AlbumId == 3, x => x.Name, false, x => x.TrackId).Result;
        Assert.AreEqual(5, ids[0]);
        Assert.AreEqual(4, ids[1]);
    }
    ...
    {
        var ids = Dao.Track.SelectAsync(x => x.AlbumId == 3, x => x.Name, true, 1, 1, x => x.TrackId).Result;
        Assert.AreEqual(5, ids[0]);
    ...
    {
        var ids = Dao.Track.SelectAsync(x => x.AlbumId == 3, x => x.Name, false, 1, 1, x => x.TrackId).Result;
        Assert.AreEqual(4, ids[0]);
        Assert.AreEqual(1, ids.Count);
    }
}