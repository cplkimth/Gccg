...
public partial class GenreApiTest
{
    ...
    public async Task ExistsByKey()
    {
        ...
        (await Dao.Genre.ExistsByKeyAsync(first.GenreId )).Should().BeTrue();
    }
    ...
    public async Task Exists()
    {
        ...
        (await Api.Genre.ExistsByKeyAsync(first.GenreId )).Should().BeTrue();
    }
    ...
    public async Task DeleteByKey()
    {
        ...
        (await Api.Genre.ExistsByKeyAsync(first.GenreId )).Should().BeFalse();
    }
    ...
    public async Task Update()
    {
        ...
        GenreDaoTest.GetUpdateField(entity).Should().Be(value);
    }
