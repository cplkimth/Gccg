...
public partial class CodeCategoryApiTest
{
    ...
    public async Task Insert()
    {
        ...
        CodeCategoryDaoTestAsync.FillForInsert(entity);
    ...
    public async Task Update()
    {
        ...
        object value = CodeCategoryDaoTestAsync.SetUpdateField(entity);
        await Api.CodeCategory.Update(entity);

        entity = await Api.CodeCategory.GetFirst();

        CodeCategoryDaoTestAsync.GetUpdateField(entity).ShouldBe(value);
    }
