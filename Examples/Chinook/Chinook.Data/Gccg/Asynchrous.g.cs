...
public abstract partial class EntityDao<T> where T : Entity<T>, new()
{
    ...
    public async Task<int> ExecuteUpdateAsync(Expression<Func<T, bool>> predicate, Action<UpdateSettersBuilder<T>> setterBuilder, CancellationToken ctk = default)
    {
        await using var context = DbContextFactory.Create();

        return await context.Set<T>().Where(predicate).ExecuteUpdateAsync(setterBuilder, ctk);
    }
...
public partial class AlbumDao
{
    ...
    public Task<int> ExecuteUpdateByKeyAsync(int albumId , Action<UpdateSettersBuilder<Album>> setterBuilder)
        => ExecuteUpdateAsync(x => x.AlbumId == albumId , setterBuilder);
}
#endregion AlbumDao
...
public partial class ArtistDao
{
    ...
    public Task<int> ExecuteUpdateByKeyAsync(int artistId , Action<UpdateSettersBuilder<Artist>> setterBuilder)
        => ExecuteUpdateAsync(x => x.ArtistId == artistId , setterBuilder);
}
#endregion ArtistDao
...
public partial class CodeDao
{
    ...
    public Task<int> ExecuteUpdateByKeyAsync(int codeId , Action<UpdateSettersBuilder<Code>> setterBuilder)
        => ExecuteUpdateAsync(x => x.CodeId == codeId , setterBuilder);
}
#endregion CodeDao
...
public partial class CodeCategoryDao
{
    ...
    public Task<int> ExecuteUpdateByKeyAsync(int codeCategoryId , Action<UpdateSettersBuilder<CodeCategory>> setterBuilder)
        => ExecuteUpdateAsync(x => x.CodeCategoryId == codeCategoryId , setterBuilder);
}
...
public partial class CustomerDao
{
    ...
    public Task<int> ExecuteUpdateByKeyAsync(int customerId , Action<UpdateSettersBuilder<Customer>> setterBuilder)
        => ExecuteUpdateAsync(x => x.CustomerId == customerId , setterBuilder);
}
...
public partial class DateTableDao
{
    ...
    public Task<int> ExecuteUpdateByKeyAsync(DateOnly date , Action<UpdateSettersBuilder<DateTable>> setterBuilder)
        => ExecuteUpdateAsync(x => x.Date == date , setterBuilder);
}
...
public partial class EmployeeDao
{
    ...
    public Task<int> ExecuteUpdateByKeyAsync(int employeeId , Action<UpdateSettersBuilder<Employee>> setterBuilder)
        => ExecuteUpdateAsync(x => x.EmployeeId == employeeId , setterBuilder);
}
...
public partial class GenreDao
{
    ...
    public Task<int> ExecuteUpdateByKeyAsync(int genreId , Action<UpdateSettersBuilder<Genre>> setterBuilder)
        => ExecuteUpdateAsync(x => x.GenreId == genreId , setterBuilder);
}
#endregion GenreDao
...
public partial class InvoiceDao
{
    ...
    public Task<int> ExecuteUpdateByKeyAsync(int invoiceId , Action<UpdateSettersBuilder<Invoice>> setterBuilder)
        => ExecuteUpdateAsync(x => x.InvoiceId == invoiceId , setterBuilder);
}
...
public partial class InvoiceLineDao
{
    ...
    public Task<int> ExecuteUpdateByKeyAsync(int invoiceLineId , Action<UpdateSettersBuilder<InvoiceLine>> setterBuilder)
        => ExecuteUpdateAsync(x => x.InvoiceLineId == invoiceLineId , setterBuilder);
}
...
public partial class MediaTypeDao
{
    ...
    public Task<int> ExecuteUpdateByKeyAsync(int mediaTypeId , Action<UpdateSettersBuilder<MediaType>> setterBuilder)
        => ExecuteUpdateAsync(x => x.MediaTypeId == mediaTypeId , setterBuilder);
}
...
public partial class PlaylistDao
{
    ...
    public Task<int> ExecuteUpdateByKeyAsync(int playlistId , Action<UpdateSettersBuilder<Playlist>> setterBuilder)
        => ExecuteUpdateAsync(x => x.PlaylistId == playlistId , setterBuilder);
}
...
public partial class PlaylistTrackDao
{
    ...
    public Task<int> ExecuteUpdateByKeyAsync(int playlistId , int trackId , Action<UpdateSettersBuilder<PlaylistTrack>> setterBuilder)
        => ExecuteUpdateAsync(x => x.PlaylistId == playlistId && x.TrackId == trackId , setterBuilder);
}
...
public partial class PlaylistTrackHistoryDao
{
    ...
    public Task<int> ExecuteUpdateByKeyAsync(int playlistId , int trackId , DateTime writtenAt , Action<UpdateSettersBuilder<PlaylistTrackHistory>> setterBuilder)
        => ExecuteUpdateAsync(x => x.PlaylistId == playlistId && x.TrackId == trackId && x.WrittenAt == writtenAt , setterBuilder);
}
...
public partial class TimeTableDao
{
    ...
    public Task<int> ExecuteUpdateByKeyAsync(TimeOnly time , Action<UpdateSettersBuilder<TimeTable>> setterBuilder)
        => ExecuteUpdateAsync(x => x.Time == time , setterBuilder);
}
...
public partial class TrackDao
{
    ...
    public Task<int> ExecuteUpdateByKeyAsync(int trackId , Action<UpdateSettersBuilder<Track>> setterBuilder)
        => ExecuteUpdateAsync(x => x.TrackId == trackId , setterBuilder);
}
#endregion TrackDao
