...
// This file has been generated by Gccg on 2024-07-24 오후 11:42:31.
#region using
...
public partial class CodeBaseApi : EntityApi<Code>
{
    ...
    public virtual async Task<int> DeleteAsync(int codeId )
    {
        using HttpClient client = CreateHttpClient();
...
public partial class CodeCategoryBaseApi : EntityApi<CodeCategory>
{
    ...
    public virtual async Task<int> DeleteAsync(int codeCategoryId )
    {
        using HttpClient client = CreateHttpClient();
...
public partial class DateTableBaseApi : EntityApi<DateTable>
{
    ...
    public virtual async Task<int> DeleteAsync(DateOnly date )
    {
        using HttpClient client = CreateHttpClient();
...
public partial class TimeTableBaseApi : EntityApi<TimeTable>
{
    ...
    public virtual async Task<int> DeleteAsync(TimeOnly time )
    {
        using HttpClient client = CreateHttpClient();
